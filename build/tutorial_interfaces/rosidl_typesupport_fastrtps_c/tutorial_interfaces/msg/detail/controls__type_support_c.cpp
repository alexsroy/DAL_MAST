...
#include "tutorial_interfaces/msg/detail/controls__rosidl_typesupport_fastrtps_c.h"
...
using _Controls__ros_msg_type = tutorial_interfaces__msg__Controls;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
bool cdr_serialize_tutorial_interfaces__msg__Controls(
  const tutorial_interfaces__msg__Controls * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: target_sail_angle
  {
    cdr << ros_message->target_sail_angle;
  }

  // Field name: target_sailflap_angle
  {
    cdr << ros_message->target_sailflap_angle;
  }

  // Field name: target_backflap_angle
  {
    cdr << ros_message->target_backflap_angle;
  }

  // Field name: target_rudder_angle
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
bool cdr_deserialize_tutorial_interfaces__msg__Controls(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces__msg__Controls * ros_message)
{
  // Field name: target_sail_angle
  {
    cdr >> ros_message->target_sail_angle;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t get_serialized_size_tutorial_interfaces__msg__Controls(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__msg__Controls(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces__msg__Controls;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
bool cdr_serialize_key_tutorial_interfaces__msg__Controls(
  const tutorial_interfaces__msg__Controls * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: target_sail_angle
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t get_serialized_size_key_tutorial_interfaces__msg__Controls(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Controls__ros_msg_type * ros_message = static_cast<const _Controls__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_key_tutorial_interfaces__msg__Controls(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const tutorial_interfaces__msg__Controls * ros_message = static_cast<const tutorial_interfaces__msg__Controls *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_tutorial_interfaces__msg__Controls(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  tutorial_interfaces__msg__Controls * ros_message = static_cast<tutorial_interfaces__msg__Controls *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_tutorial_interfaces__msg__Controls(cdr, ros_message);
}

static uint32_t _Controls__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__msg__Controls(
...
static size_t _Controls__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__msg__Controls(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, msg, Controls)() {
